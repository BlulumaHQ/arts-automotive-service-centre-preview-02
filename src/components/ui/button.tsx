  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-button",
        ghost: "hover:bg-accent hover:text-accent-foreground rounded-button",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-button text-lg shadow-subtle hover:shadow-card-hover",
        cta: "bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-button",
      },
      size: {
